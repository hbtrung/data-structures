...
public class ArrayRingBuffer<T> extends AbstractBoundedQueue<T>{
    ...
    public T dequeue() {
        ...
        if (capacity() == 0) throw new RuntimeException("Ring buffer underflow");
        T item = rb[first];
        rb[first] = null;
    ...
    public T peek() {
        ...
        if (capacity() == 0) throw new RuntimeException("No item to return");
        return rb[first];
    }
    ...
    private class KeyIterator implements Iterator<T> {
        ...
        public boolean hasNext() {
            return ptr != last || fillCount == capacity;
        }
